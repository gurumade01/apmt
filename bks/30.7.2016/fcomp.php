...
<div class="container-fluid">
	<div class="list-group subcate">
	  <a href="fcopen.php?comptype=CO" class="list-group-item"><i class="fa fa-tasks" aria-hidden="true"></i>Open Complaints <span class="badge"><?php echo $todayCount; ?></span></a>
