...
<div class="progress adminprog">
  ...
  <div id="adminbotbutt">
	<a href="newnotif.php" class="btn btn-primary btn-block"><i class="fa fa-bell" aria-hidden="true"></i>  &nbsp; Create Notification</a>
	<a href="complaint.php" class="btn btn-primary btn-block"><i class="fa fa-wrench" aria-hidden="true"></i> &nbsp; Create Complaint</a>
	<a href="#" class="btn btn-primary btn-block"><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp; Create New User</a>
  </div>
