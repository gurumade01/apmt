	...
	//$userlogid = 9999;
		...
		//	$userevereg = 1;
			...
			for($i=0;$i<$arrcount;$i++){
				$eoutput1 .='<div class="panel panel-default insidePanel userregcolor">';
			...
			//	$eoutput1 .= "<a href=feveindi.php?eid=".$eidOWN[$i]."&etitle=".$etitleOWN[$i]."&eby=".$ebyOWN[$i]."&ebyname=".$ebynameOWN[$i]."&userevereg=".$userevereg."&edate=".$edateOWN[$i].">";
				$eoutput1 .= "<a href=feveindi.php?eid=".$eidOWN[$i]."&etitle=".$etitleOWN[$i]."&eby=".$ebyOWN[$i]."&ebyname=".$ebynameOWN[$i]."&edate=".$edateOWN[$i].">";
				...
				$eoutput1 .=	'<i class="fa fa-user" aria-hidden="true"></i> <span id="eveBy">'.$ebynameOWN[$i].'</span>';
				
				$eoutput1 .=	'<i class="fa fa-home spa" aria-hidden="true"></i> <span  id="eveByHome">'.$ebyOWN[$i].'</span>';

				$eoutput1 .=	'<br/>';
						
				$eoutput1 .=	'<i class="fa fa-calendar" aria-hidden="true"></i> <span id="eveDate" >'.$edateOWN[$i].'</span>';
				...
				$eoutput .=	'<div class="eveBut">';
					...
					$eoutput1 .=	'<div class="ieveRegStat pull-right"><i class="fa fa-bookmark" aria-hidden="true"></i> You Registered</div>';
				...
				$eoutput1 = '<p class="text-center"> No registered events available. </p>';
		}
