...
<?php include 'incl/testcount.php';?>
  ...
  <div class="container" id="adminbotbutt">
	<a href="fadmincontrols.php" class="btn btn-primary btn-block"><i class="fa fa-tachometer" aria-hidden="true"></i> &nbsp; Admin Controls</a>
  </div>
