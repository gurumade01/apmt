		...
		if(isset($_GET['e'])) {
			...
			if(mysqli_num_rows($result)) {
				...
				$eoutput = "";
					...
					$eoutput .=	'<div class="container panel-group">';
				for($i=0;$i<$arrcount;$i++){
					$insidecol = "";
					if($ETYPE[$i]==0) {
						$insidecol = 'userregcolor';
					}
					$eoutput .='<div class="panel panel-default panel-small insidePanel  userregcolor ">';
