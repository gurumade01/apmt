...
<div class="container">
	<form method="POST" role="form">
		...
		<div class="form-group">
			...
			<div class="radio">
			  <label><input type="radio" id="nto2" name="nto" value="0">To Apartment</label>
			</div>
			
			<!-- 
				<div class="radio">
			  <label><input type="radio" id="nto3" name="nto" value="2">To Worker</label>
			</div>
			-->
		...
		<div class="form-group" id="inputaptnum" style="display:none;">
			<label for="napt">Enter Apartment Number</label>
			<input type="number" class="form-control" id="napt" name="napt" maxlength="3" placeholder="Apartment Number">
		</div>
		
		<!-- 
			<div class="form-group" id="inputuid" style="display:none;">
			<label for="napt1">Enter User ID</label>
			<input type="number" class="form-control" id="napt1" name="napt1" maxlength="3" placeholder="User ID">
			</div>
		-->
	...
	<!-- jQuery 
		...
		/* 
			   if(radioValue == 2) {
			$("#inputuid").css("display","block");
		  } else {
			$("#inputuid").css("display","none");
		  }
		*/
